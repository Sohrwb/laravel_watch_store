...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
            ...
            {{-- محتوای اصلی (سمت چپ در دسکتاپ) --}}
            <div class="col-md-9">
                {{-- دکمه فیلتر برای موبایل --}}
                <button class="btn btn-outline-primary d-md-none mb-3" id="openSidebarBtn">
                    فیلتر محصولات
                </button>
                ...
                <div id="discountedProductCarousel" class="carousel slide mb-5" data-bs-ride="carousel" data-bs-interval="5000">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card mb-3 bg-dark shadow-sm position-relative">
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    @if ($product->count > 0)
                                                        <a href="{{ route('product.show', $product) }}" class="btn btn-primary">مشاهده</a>
                                                    @else
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#discountedProductCarousel" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon bg-dark rounded" aria-hidden="true"></span>
                        <span class="visually-hidden">قبلی</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#discountedProductCarousel" data-bs-slide="next">
                ...
                <div class="row">
                    @foreach ($categories as $category)
                        @php
                            ...
                            $randomProducts = $availableProducts->count() > 4 ? $availableProducts->random(4) : $availableProducts;
                        @endphp
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-sm">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('category.show', $category->id) }}" class="btn btn-sm btn-outline-primary">مشاهده بیشتر</a>
                                </div>
                                <div class="card-body">
                                    <div class="row g-3">
                                            ...
                                            <div class="col-6">
                                                <div class="category-product-card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @if ($hasDiscount)
                                                            <p class="text-danger text-decoration-line-through mb-0" style="font-size: 0.8rem;">
                                                                {{ number_format($product->price) }} تومان
                                                            </p>
                                                        ...
                                                        @endif
                                                        <a href="{{ route('product.show', $product->id) }}" class="btn btn-primary btn-sm btn-view">مشاهده</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
            ...
            <div class="col-md-3 d-none d-md-block">
                <div class="bg-white border-start shadow-sm p-3">
    ...
    {{-- سایدبار فیلتر موبایل (offcanvas) --}}
    ...
    {{-- اسکریپت فعال‌سازی سایدبار موبایل --}}
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const openBtn = document.getElementById('openSidebarBtn');
            const mobileSidebar = new bootstrap.Offcanvas('#mobileFilterSidebar');
